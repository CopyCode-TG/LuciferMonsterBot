class script(object):   
    ...
    ABOUT_TXT = """<b>➭𝐁ᴏᴛ : {}
➭𝐃ᴇᴠ :  <a href=https://t.me/TG_x_filter>CᴏᴘʏCᴏᴅᴇ™🇮🇳</a>
➭𝐂ʀᴇᴀᴛᴏʀ : <a href=tg://settings>𝐓ʜɪs 𝐏ᴇʀsᴏɴ</a>
➭𝐋ᴀɴɢᴜᴀɢᴇ : 𝐏ʏᴛʜᴏɴ3
➭𝐋ɪʙʀᴀʀʏ : 𝐏ʏʀᴏɢʀᴀᴍ
➭𝐕ᴇʀsɪᴏɴ : 3.11.0 [𝐁ᴇᴛᴀ]
➭𝐒ᴏᴜʀᴄᴇ 𝐂ᴏᴅᴇ : <a href=https://t.me/copycod_Official>𝐂ʟɪᴄᴋ 𝐇ᴇʀᴇ</a></b>"""

    SOURCE_TXT = """𝙸𝙵 𝚈𝙾𝚄 𝙵𝙰𝙲𝙸𝙽𝙶 𝙰𝙽𝚈 𝙸𝚂𝚂𝚄𝙴 𝙸𝙽 𝚃𝙷𝙴 𝚁𝙴𝙿𝙾 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴...👇"""
...
📢 Bᴏᴛ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ.</b>"""
    DEV = """<b>●𝐅ɪʀsᴛ 𝐍ᴀᴍᴇ : CᴏᴘʏCᴏᴅᴇ™🇮🇳
●𝐔sᴇʀ  𝐍ᴀᴍᴇ : @TG_x_filter
●𝐔sᴇʀ  𝐋ɪɴᴋ : <a href=https://t.me/TG_x_filter>𝐂ʟɪᴄᴋ 𝐇ᴇʀᴇ</a></b>"""
