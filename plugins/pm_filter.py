...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, SINGLE_BUTTON, PROTECT_CONTENT, \
    SPELL_CHECK_REPLY, IMDB_TEMPLATE, SPELL_IMG, IMDB_DELET_TIME, START_MESSAGE, PMFILTER, G_FILTER, BUTTON_LOCK, BUTTON_LOCK_TEXT, NOR_IMG
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            InlineKeyboardButton('※ 𝐂ʟɪᴄᴋ 𝐇ᴇʀᴇ 𝐅ᴏʀ 𝐌ᴏʀᴇ 𝐁ᴜᴛᴛᴏɴs ※', callback_data='help2')
            ],[                       
            InlineKeyboardButton('⭗ 𝐅ɪʟᴛᴇʀs ⭗', callback_data='filters'),
            InlineKeyboardButton('⭗ 𝐒ᴇᴛᴛɪɴɢs ⭗', callback_data='howtoues')
            ],[
            InlineKeyboardButton('⭗ 𝐂ᴏɴɴᴇᴄᴛɪᴏɴs ⭗', callback_data='coct'),
            InlineKeyboardButton('⭗ 𝐄xᴛʀᴀ-𝐌ᴏᴅs ⭗', callback_data='extra')   
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐃ᴇᴘʟᴏʏ', callback_data='suneesh')
            ],[
            InlineKeyboardButton('❮', callback_data='help2'),
            InlineKeyboardButton('⌂ 𝐇ᴏᴍᴇ', callback_data='start')
            ],[
            InlineKeyboardButton('⛌ 𝐂ʟᴏsᴇ 𝐌ᴏʀᴇ 𝐁ᴜᴛᴛᴏɴs ⛌', callback_data='close_data')
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
            text=script.HELP_TXT.format(query.from_user.mention),
        ...
        buttons= [[
            ...
            InlineKeyboardButton('⎙ 𝐃ᴇᴠs', callback_data='source')
            ],[
            InlineKeyboardButton('⏍ 𝐅ɪʟᴇs 𝐒ᴛᴀᴛᴜs ⏍', callback_data='stats')
            ],[
            InlineKeyboardButton('⌂ 𝐇ᴏᴍᴇ ', callback_data='start'),
            InlineKeyboardButton('𝐂ʟᴏsᴇ ⛌', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('­­­­𝐂𝐨𝐩𝐲𝐂𝐨𝐝𝐞{👨🏻‍💻}™🇮🇳', url='https://t.me/TG_x_filter')
            ],[
            InlineKeyboardButton('ꪶ‌ꪆ KD Tech [#Offline] 🇮🇳', url='https://t.me/dxfilter')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⤆𝐁ᴀᴄᴋ', callback_data='help3')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⤆𝐁ᴀᴄᴋ', callback_data='help2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⤆𝐁ᴀᴄᴋ', callback_data='manuelfilter2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[            
            InlineKeyboardButton('⤆𝐁ᴀᴄᴋ', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
